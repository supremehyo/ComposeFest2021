...
import com.codelab.theming.ui.start.theme.JetnewsTheme2
...
fun Header(
    ...
    Surface(
        color = MaterialTheme.colors.onSurface.copy(alpha = 0.1f),//불투명도가 0,1인 컬러 복사본을 만들어냄
